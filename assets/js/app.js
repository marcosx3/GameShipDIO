...
musica.play();  
	...
	var KEYS = {
        ...
        S:83,
        ArrowDown: 40,
        D:68,  // TECLA DE DISPARO || OU BACKSPACE
        BSPACE: 190
    }
    jogo.pressionou = []
    var velocidade=5;
...
// Funcao que movimenta o background do jogo
function moveFundo() {
...
// Movimentacao de Jogador
    function  moveJogador(){
	    ...
	    if (jogo.pressionou[KEYS.W] || jogo.pressionou[KEYS.ArrowUP]) {
	    	var topo = parseInt($("#jogador").css("top")); // PEGA O VALOR DO ID E CONVERTE EM UM INTEIRO        
	    	$("#jogador").css("top",topo - 10); // USA O VALOR DO ID - 10
        if (topo<=0) {
	    ...
	    if (jogo.pressionou[KEYS.S] || jogo.pressionou[KEYS.ArrowDown]) {
	    ...
	    if (jogo.pressionou[KEYS.D] || jogo.pressionou[KEYS.BSPACE]) {
            disparo();
    ...
    function moveinimigo1() {
        ...
        $("#inimigo1").css("top",posicaoY);
            ...
            if (posicaoX <= 0) {
                posicaoY = parseInt(Math.random() * 337);
  ...
  //Barra de energia
    ...
    function energia() {
        ...
        if (energiaAtual==2) {
            ...
            $("#energia").css("background-image", "url(./assets/imgsenergia2.png)");
        }
